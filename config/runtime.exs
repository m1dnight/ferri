...
#
#     PHX_SERVER=true bin/ferri start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ferri, FerriWeb.Endpoint, server: true
end

config :ferri, FerriWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
...
if config_env() == :prod do
  ...
  config :ferri, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
